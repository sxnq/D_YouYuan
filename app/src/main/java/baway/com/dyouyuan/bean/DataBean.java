...
////    Long id,
//    public DataBean(String area, int picWidth, long createtime,
//            int picHeight, String gender, double lng, String introduce,
//            String imagePath, Integer userId, String yxpassword, String password,
...
//    }
    ...
    @Generated(hash = 1458386619)
    public DataBean(String area, int picWidth, long createtime, int picHeight, String gender,
            double lng, String introduce, String imagePath, Long userId, String yxpassword,
            String password, long lasttime, String phone, String nickname, String age, double lat) {
        this.area = area;
        this.picWidth = picWidth;
        this.createtime = createtime;
        this.picHeight = picHeight;
